...
def step_impl(context, src, value):
    ...
    context.result = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(src, value))
...
def step_impl(context, dst, values):
    ...
    context.result = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(values, dst))
...
def step_impl(context, src, count):
    ...
    context.stats = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(src, count))
...
def step_impl(context, src, values, dst):
    ...
    context.result = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(src, values, dst))
...
def step_impl(context, src, values):
    ...
    context.result = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(src, values))
...
def step_impl(context, src, value, dst):
    ...
    context.result = cicada.communicator.SocketCommunicator.run(operation, world_size=context.players, args=(src, value, dst))
...
def step_impl(context, count):
    ...
    for i in range(count):
        cicada.communicator.SocketCommunicator.run(operation, world_size=context.players)
